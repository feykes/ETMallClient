...
const routes: Routes = [
  {path:"admin", component:LayoutComponent, children:[
    {path:"", component:DashboardComponent}, //anasayfa niteliğinde olan componentlerde direkt component çağrılır
...
{path:"",component:HomeComponent}, //ana component olduğu için direkt
